...
**[v0.7.1](https://github.com/chienchuanw/only-cue/releases/tag/v0.7.1) is the latest release** — a downloadable DMG that fixes the launch flow: opening OnlyCue now shows only the "Welcome to OnlyCue" start window, no longer popping the macOS Open dialog beside it.
