...
**[v0.9.0](https://github.com/chienchuanw/only-cue/releases/tag/v0.9.0) is the latest release** — a downloadable DMG adding **Show mode GO**: a GO button, the Return key, and the OSC address `/onlycue/cue/go` to walk the cue list one hit at a time while audio and LTC timecode keep running.
