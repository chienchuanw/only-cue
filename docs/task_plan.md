...
| [#39](https://github.com/chienchuanw/only-cue/issues/39) | Templates — CuePoint Type sets (depends on #32) | p2 | 🟡 in progress (4 of 5 leaves shipped in PR [#140](https://github.com/chienchuanw/only-cue/pull/140) — format / save / load / tests + ADR-015; remaining: new-document-from-template UX [splash dropdown / shortcut binding TBD since `⇧⌘N` is taken by Show Notes Overlay]) |
