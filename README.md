...
| **Stand-alone leaves** | Cue inspector commits drafts on outside-click (window-scoped `NSEvent` monitor); File → Import Media… menu entry with ⌘O (canonical menu owner). |
...
- **Phase 2 — Pro handoff** — nine epics filed, three in flight (#32 complete, #36 in progress, #38 in progress). Open epics: [#33](https://github.com/chienchuanw/only-cue/issues/33) LTC, [#34](https://github.com/chienchuanw/only-cue/issues/34) console export (CSV/MA2/MA3), [#35](https://github.com/chienchuanw/only-cue/issues/35) OSC remote, [#37](https://github.com/chienchuanw/only-cue/issues/37) timeline breakdown view, [#39](https://github.com/chienchuanw/only-cue/issues/39) templates, [#40](https://github.com/chienchuanw/only-cue/issues/40) custom shortcuts editor.
