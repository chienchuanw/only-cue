...
- [x] [#76](https://github.com/chienchuanw/only-cue/issues/76) — File > Import Media… menu entry (planned, user-pre-authored spec + plan ready: `docs/superpowers/specs/2026-05-09-import-media-file-menu-design.md` + `docs/superpowers/plans/2026-05-09-import-media-file-menu.md`).
