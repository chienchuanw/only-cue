...
**[v0.6.4](https://github.com/chienchuanw/only-cue/releases/tag/v0.6.4) is the latest release** — a downloadable DMG that fixes the relink flow (choosing a file now actually repoints the clip and loads its audio — the v0.6.3 relink was non-functional) and centers the active clip's filename at the top of the inspector on the plain background.
