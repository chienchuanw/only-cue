...
**[v0.7.4](https://github.com/chienchuanw/only-cue/releases/tag/v0.7.4) is the latest release** — a downloadable DMG that renders the waveform from per-bucket RMS energy, so loud brickwall-limited masters show their real loudness dynamics and song structure instead of collapsing into a solid saturated block.
