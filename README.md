...
**[v0.6.6](https://github.com/chienchuanw/only-cue/releases/tag/v0.6.6) is the latest release** — a downloadable DMG that makes a relinked clip's waveform render immediately, instead of staying on the spinner until you switch media and back.
